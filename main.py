...
async def seed_categories():
    # ডাটাবেসের পুরোনো ক্যাটাগরি কালেকশন সম্পূর্ণ ক্লিন করে হুবহু আপনার ক্রমানুসারে রিলোড করবে
    ...
    logger.info("Database categories perfectly re-seeded in custom sequence!")
